...
* [**Lesson 1: Structure, Indexing, and Logic**](http: http://scbi-migbirds.github.io/structureIndexingAndLogic.html): In this lesson, which is a subset of our preliminary course, [**Introduction to R**](http://scbi-migbirds.github.io/IntroductionToR.html), we will review the overall structure of data in R and learn how to use that structure for data manipulation. The emphasis of this lesson is to build an understanding of the R language.
