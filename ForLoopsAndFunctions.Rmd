...
$$N_t = N_0 \cdot e^{r \cdot t}$$
    ...
    a. Convert the exponential population growth model to an R function with _r_ and _N_ as unknowns. _Note: $e^rt$ is written as exp(r*t)_
...
3. The logistic population growth model (Verhulst) states that the growth of the population will be constrained by the population carrying capacity (_K_) as a function of resource limitations. This model is summarized as (_Note: the remaining variables as are above_):
