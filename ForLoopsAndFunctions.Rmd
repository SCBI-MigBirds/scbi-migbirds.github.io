...
We may also be interested in using a _for loop_ to generate a vector of numbers based on some mathematical operation. For example, consider we have a number, 10, and want to calculate multiples of 10.
...
>* _**Hint 2**: The for loop initialization will begin at three, it will **NOT** include all of 1:20!_
...
>3. Create a function that calculates the mean count for a selected trait and guild across sites.
